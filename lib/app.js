...
function doMouseDown(event) {
  ...
  console.log(
    "near: " +
      obj_clicked_pos_near[0] +
      " , " +
      obj_clicked_pos_near[1] +
      " , " +
      obj_clicked_pos_near[2]
  );
  console.log(
    "far: " +
      obj_clicked_pos_far[0] +
      " , " +
      obj_clicked_pos_far[1] +
      " , " +
      obj_clicked_pos_far[2]
  );
  ...
  obj_pos = linePlaneIntersection(
    obj_clicked_pos_far - obj_clicked_pos_near,
    obj_clicked_pos_near,
    testNormal,
    testPoint
  );
  ...
  obj_pos2 = linePlaneIntersection2(
    p1,
    p2,
    p3,
    obj_clicked_pos_near,
  ...
  console.log(
    "pos: " + obj_pos2[0] + " , " + obj_pos2[1] + " , " + obj_pos2[2]
  );
...
function drawScene() {
  ...
  let smallCubesArray = rubiksCube.cubes;

  for (x = 0; x < 3; x++) {
    for (y = 0; y < 3; y++) {
      for (z = 0; z < 3; z++) {
        let smallCube = smallCubesArray[x][y][z];
        let smallCubeMatrix = utils.MakeWorld(
          smallCube.coordinates[0],
          smallCube.coordinates[1],
          smallCube.coordinates[2],
          0,
          0,
          0,
          0.5
